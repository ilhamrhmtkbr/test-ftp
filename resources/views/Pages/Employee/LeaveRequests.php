    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
                ...
                <div class="col-md-8 mb-3">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <?php
                            $listName = 'Start Date From';
                            $listParam = 'start_date_from';
                            require __DIR__ . '/../../Components/_filter/ByDate.php';
                            ?>
                        </div>
                        <div class="col-md-6 mb-2">
                            <?php
                            $listName = 'Start Date Until';
                            $listParam = 'start_date_until';
                            require __DIR__ . '/../../Components/_filter/ByDate.php';

                            ?>
                        </div>
                    </div>
                    <div class="btn btn-outline-primary btn-sm col" onclick="
            ...
            ">
                    ...
                    <?php
                    $floatName = 'start-date-until';
                    if (isset($_GET['start_date_from']) && (!isset($_GET['start_date_until']))) {
                        $session = [
                                'float' => [
                                        'type' => 'danger',
                                        'message' => 'Start Date Until Tidak Boleh Kosong',
                                        'name' => $floatName
                                ]
                        ];
                    }
