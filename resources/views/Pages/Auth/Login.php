                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                $badgeName = 'error-login';
                                require __DIR__ . '/../../Components/_alert/BadgeWithClose.php';
                                ?>
                                <form action="/user/login" method="POST" class="user">
                                    <div class="form-group">
                                        <input type="email" name="email" value="<?= $_POST['email'] ?? '' ?>" class="form-control form-control-user"
                                    ...
                                    <div class="form-group">
                                        <input type="password" value="<?= $_POST['password'] ?? '' ?>" name="password" class="form-control form-control-user"
