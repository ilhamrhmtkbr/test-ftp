...
<head>
    <title>Laporan Employee Project Assignments</title>
    <style>
        :root {
            --bg-color: #ffffff;
...
<body>
    <h3>Laporan Employee Project Assignments</h3>
                    ...
                    foreach ($data['results'] as $items) : ?>
                        <tr>
                            ...
                            <?php foreach ($items as $key => $value) : ?>
                                ...
                                <td <?= ($key == 'name' || $key == 'project_name' || $key == 'role_in_project') ? "class='max-width'" : '' ?>>
