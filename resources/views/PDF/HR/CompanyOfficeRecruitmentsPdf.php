...
<head>
    <title>Laporan Company Office Recruitments</title>
    <style>
        :root {
            --bg-color: #ffffff;
...
<body>
    <h3>Laporan Company Office Recruitments</h3>
                    ...
                    foreach ($data['results'] as $items) : ?>
                        <tr>
                            ...
                            <?php foreach ($items as $key => $value) : ?>
                                ...
                                <td <?= ($key == 'status' || $key == 'created_at' || $key == 'updated_at') ? "style='text-align:center;'" : '' ?>
                                    <?= $key == 'job_description' ? "class='max-width'" : '' ?>>
