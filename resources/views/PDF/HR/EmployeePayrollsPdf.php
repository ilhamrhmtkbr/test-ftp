...
<head>
    <title>Laporan Employee Payrolls</title>
    <style>
        :root {
            --bg-color: #ffffff;
...
<body>
    <h3>Laporan Employee Payrolls</h3>
                ...
                <thead>
                    <tr>
                        ...
                        <?php foreach (array_keys((array)$data['results'][0]) as $key): ?>
                            <?php if ($key == 'id' || $key == 'email' || $key == 'base_salary' || $key == 'total_overtime' || $key == 'late_penalties' || $key == 'created_at' || $key == 'updated_at') {
                                continue;
                            } ?>
                        ...
                        <tr>
                            ...
                            <?php foreach ($items as $key => $value) : ?>
                                ...
                                <td <?= ($key != 'name') ? "style='text-align:center;'" : '' ?>
                                    <?= ($key == 'name' || $key == 'department') ? "class='max-width'" : '' ?>>
                                    <?php if ($key == 'payment_date') {
                                        echo TimeHelper::getTime($value);
                                    } elseif ($key == 'net_salary') {
