...
<head>
    <title>Laporan Employee Leave Requests</title>
    <style>
        :root {
            --bg-color: #ffffff;
...
<body>
    <h3>Laporan Employee Leave Requests</h3>
                ...
                <thead>
                    <tr>
                        ...
                        <?php foreach (array_keys((array)$data['results'][0]) as $key): ?>
                            <?php if ($key == 'id' || $key == 'email' || $key == 'created_at' || $key == 'updated_at') {
                                continue;
                            } ?>
                    ...
                    foreach ($data['results'] as $items) : ?>
                        <tr>
                            ...
                            <?php foreach ($items as $key => $value) : ?>
                                ...
                                <td <?= $key == 'remarks' ? "class='max-width'" : '' ?>
