                    ...
                    foreach ($data['results'] as $items) : ?>
                        <tr>
                            ...
                            <?php foreach ($items as $key => $value) : ?>
                                ...
                                <td style='text-align:center;' <?= $key != 'contract_terms' ? "class='max-width'" : '' ?>>
                                    <?php if ($key == 'attendance_date' || $key == 'contract_start_date' || $key == 'contract_end_date') {
